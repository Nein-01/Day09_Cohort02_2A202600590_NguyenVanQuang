...
QUESTION = (
    "Công ty trốn thuế bằng cách không báo cáo thu nhập từ nước ngoài, và cũng đã chia sẻ dữ liệu người dùng mà không có sự đồng ý rõ ràng. Tìm án lệ cho vi phạm này của công ty."
)
